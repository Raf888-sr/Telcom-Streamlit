    ...
    <div class="mw9 center pa4 pt5-ns ph7-l">
      ...
      <h3 class="f2 f1-m f-headline-l measure-narrow lh-title mv0">
        <span class="bg-black-90 lh-copy white pa1 tracked-tight">
          Machine Learning Project: <br> Telco Customer Churn
        </span>
      </h3>
...
if menu_id == "Profiling":
    ...
    with col3:
        ...
        if selected_id['gender'][0] == 'Male':
              ...
              st.write(f"""
            <div>
                <div style="display:inline-block;horizontal-align:middle;padding-left: 170px;xpadding-top:50px";">
        ...
        # Show female image
             ...
             st.write(f"""
           <div>
               <div style="display:inline-block;horizontal-align:middle;padding-left: 170px;padding-top:50px";>
